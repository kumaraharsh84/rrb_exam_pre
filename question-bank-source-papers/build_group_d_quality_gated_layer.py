...
NORMALIZED_DIR = BASE / "normalized-json" / "group-d"
OUT_DIR = BASE / "quality-gated-json" / "group-d"
SUMMARY_PATH = BASE / "quality-gated-json" / "group-d-quality-gated-summary.json"
AUDIT_PATH = BASE / "quality-gated-json" / "group-d-excluded-question-audit.json"
...
def main() -> None:
    ...
    for src in sorted(NORMALIZED_DIR.glob("*.normalized.json")):
        ...
        out_path = OUT_DIR / src.name.replace(".normalized.json", ".quality-gated.json")
