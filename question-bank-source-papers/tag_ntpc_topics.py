...
SOURCE_DIR = BASE / "bank-ready-json" / "ntpc"
OUT_DIR = BASE / "topic-tagged-json" / "ntpc"
SOURCE_FILE = SOURCE_DIR / "ntpc-2024-bank-ready.json"
COMBINED_OUT = OUT_DIR / "ntpc-2024-topic-tagged.json"
SUMMARY_OUT = OUT_DIR / "ntpc-2024-topic-tagging-summary.json"
...
def main() -> None:
    ...
    for subject, questions in sorted(by_subject.items()):
        out_file = OUT_DIR / f"ntpc-2024-{subject_slug(subject)}.topic-tagged.json"
        subject_payload = {
