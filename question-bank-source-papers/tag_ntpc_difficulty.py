...
SOURCE_DIR = BASE / "topic-tagged-json" / "ntpc"
OUT_DIR = BASE / "difficulty-tagged-json" / "ntpc"
SOURCE_FILE = SOURCE_DIR / "ntpc-2024-topic-tagged.json"
COMBINED_OUT = OUT_DIR / "ntpc-2024-difficulty-tagged.json"
SUMMARY_OUT = OUT_DIR / "ntpc-2024-difficulty-tagging-summary.json"
...
def main() -> None:
    ...
    for subject, questions in sorted(by_subject.items()):
        out_file = OUT_DIR / f"ntpc-2024-{subject_slug(subject)}.difficulty-tagged.json"
        subject_payload = {
            "exam": output["exam"],
