...
PDF_DIR = BASE / "technician-grade-3"
SOURCE_DIR = BASE / "quality-gated-json" / "technician-grade-3"
OUT_DIR = BASE / "answer-recovered-json" / "technician-grade-3"
WORK_ROOT = BASE / "answer-recovery-tests" / "technician-grade-3" / "batch-2026"
SUMMARY_PATH = OUT_DIR / "technician-grade-3-2026-answer-recovery-summary.json"
...
MANUAL_VISUAL_ANSWER_FIXES = {
    "RRB-Technician-III-Questions-Paper-English-06-03-2026-S2": {
        69: "D",
        70: "A",
        71: "C",
        72: "C",
    ...
    "RRB-Technician-III-Questions-Paper-English-10-03-2026-S1": {
        6: "C",
        7: "D",
        10: "B",
        11: "A",
...
def target_pdfs() -> list[Path]:
    return sorted(PDF_DIR.glob("RRB-Technician-III-Questions-Paper-English-*.pdf"))
...
def main() -> None:
    ...
    summary = {
        "scope": "Technician Grade 3 2026 English papers",
