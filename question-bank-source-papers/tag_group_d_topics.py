...
SOURCE_DIR = BASE / "bank-ready-json" / "group-d"
OUT_DIR = BASE / "topic-tagged-json" / "group-d"
SOURCE_FILE = SOURCE_DIR / "group-d-2025-bank-ready.json"
COMBINED_OUT = OUT_DIR / "group-d-2025-topic-tagged.json"
SUMMARY_OUT = OUT_DIR / "group-d-2025-topic-tagging-summary.json"
...
def main() -> None:
    ...
    for subject, questions in sorted(by_subject.items()):
        out_file = OUT_DIR / f"group-d-2025-{subject_slug(subject)}.topic-tagged.json"
        subject_payload = {
